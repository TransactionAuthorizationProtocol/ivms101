...
import type * as IVMS101_2020 from "./ivms101_2020";
import * as IVMS101_2023 from "./ivms101_2023";

// Basic type arbitraries
export const naturalPersonNameTypeCode = () =>
	fc.constantFrom(
		"ALIA",
		"BIRT",
		"MAID",
...
export const legalPersonNameTypeCode = () =>
	fc.constantFrom(
		"LEGL",
		"SHRT",
		"TRAD",
...
export const nationalIdentifierTypeCode = () =>
	fc.constantFrom(
		"ARNU",
		"CCPT",
		"RAID",
...
export const naturalPersonNationalIdentifierTypeCode = () =>
	fc.constantFrom(
		"ARNU",
		"CCPT",
		"DRLC",
...
export const legalEntityNationalIdentifierTypeCode = () =>
	fc.constantFrom(
		"RAID",
		"FIIN",
		"TXID",
...
export const transliterationMethodCode = () =>
	fc.constantFrom(
		"arab",
		"aran",
		"armn",
...
export const date = () =>
	fc.integer({ min: 1950, max: new Date().getFullYear() - 1 }).chain((year) =>
		fc.integer({ min: 1, max: 12 }).chain((month) =>
			fc
				.integer({ min: 1, max: 28 }) // Use 28 to avoid month-specific day issues
				.map(
					(day) =>
...
export const legalPersonAddress = () =>
	fc.oneof(
		// Option 1: Use addressLine (unstructured) - structured fields must be undefined
		fc.record({
...
export const naturalPersonNationalIdentification = () =>
	fc.record({
		...
		registrationAuthority: fc.option(registrationAuthority(), {
			nil: undefined,
		}),
	}) as fc.Arbitrary<
		IVMS101_2020.NationalIdentification<IVMS101_2020.NaturalPersonNationalIdentifierTypeCode>
	>;
...
export const legalEntityNationalIdentification = () =>
	legalEntityNationalIdentifierTypeCode().chain((idType) => {
		if (idType === "LEIX") {
			...
			return fc.record({
				...
				IVMS101_2020.NationalIdentification<IVMS101_2020.LegalEntityNationalIdentifierTypeCode>
			>;
		} else {
	...
	fc
		...
		.chain(([legalName, otherNames]) =>
			...
			fc.oneof(
				...
				fc.record({
					name: fc.record({
						nameIdentifier: fc.constant([
							legalName,
							...otherNames,
						] as IVMS101_2020.NaturalPersonNameId[]),
						localNameIdentifier: fc.constant(undefined),
						phoneticNameIdentifier: fc.constant(undefined),
					}),
					geographicAddress: fc.array(address(), {
						minLength: 1,
						maxLength: 5,
					}),
					nationalIdentification: fc.option(
						naturalPersonNationalIdentification(),
						{ nil: undefined },
					),
					customerNumber: fc.option(identifier(), { nil: undefined }),
					dateAndPlaceOfBirth: fc.option(
						fc.record({
							dateOfBirth: date(),
				...
				fc.record({
					...
					geographicAddress: fc.option(
						fc.array(address(), { minLength: 1, maxLength: 5 }),
						{ nil: undefined },
					),
					nationalIdentification: fc.option(
						naturalPersonNationalIdentification(),
		...
		.chain(([legalName, otherNames]) =>
			...
			fc.oneof(
				...
				fc.record({
					name: fc.record({
						nameIdentifier: fc.constant([
							legalName,
							...otherNames,
						] as IVMS101_2020.LegalPersonNameId[]),
						localNameIdentifier: fc.constant(undefined),
						phoneticNameIdentifier: fc.constant(undefined),
					}),
					geographicAddress: fc.array(legalPersonAddress(), {
						minLength: 1,
						maxLength: 5,
					}),
					customerNumber: fc.option(identifier(), { nil: undefined }),
					nationalIdentification: fc.option(
						legalEntityNationalIdentification(),
						{ nil: undefined },
					),
				...
				fc.record({
					...
					geographicAddress: fc.option(
						fc.array(legalPersonAddress(), { minLength: 1, maxLength: 5 }),
						{ nil: undefined },
					),
					customerNumber: identifier(),
					nationalIdentification: fc.option(
...
export const person = () =>
	fc.oneof(
		fc.record({
			...
			accountNumber: fc.option(
				fc.array(identifier(), { minLength: 1, maxLength: 20 }),
				{ nil: undefined },
			),
		}),
		fc.record({
...
export const payloadMetadata = () =>
	fc.option(
		fc.record({
			transliterationMethod: fc.option(
				fc.array(transliterationMethodCode(), { minLength: 1, maxLength: 5 }),
				{ nil: undefined },
			),
		}),
		{ nil: undefined },
...
export const naturalPersonNameId2023 = () =>
	fc.record({
		primaryIdentifier: personName(),
		secondaryIdentifier: fc.option(personName(), { nil: undefined }),
...
export const naturalPerson2023 = () =>
	fc
		.tuple(
			// First name is always LEGL
			fc.record({
				...
				fc.record({
					name: fc.record({
						nameIdentifier: fc.constant([
							legalName,
							...otherNames,
						] as IVMS101_2023.NaturalPersonNameId[]),
						localNameIdentifier: fc.constant(undefined),
						phoneticNameIdentifier: fc.constant(undefined),
					}),
					geographicAddress: fc.array(address(), {
				...
				fc.record({
					name: fc.record({
						nameIdentifier: fc.constant([
							legalName,
							...otherNames,
						] as IVMS101_2023.LegalPersonNameId[]),
						localNameIdentifier: fc.constant(undefined),
						phoneticNameIdentifier: fc.constant(undefined),
					}),
					geographicAddress: fc.array(legalPersonAddress(), {
...
export const payloadMetadata2023 = () =>
	fc.option(
		fc.record({
			transliterationMethod: fc.option(
				fc.array(transliterationMethodCode(), { minLength: 1, maxLength: 5 }),
...
export const ivms101_2023Valid = () =>
	ivms101_2023().map((data) => ({
		...data,
		payloadMetadata: {
...
export const ivms101 = () =>
	fc.oneof(ivms101_2020(), ivms101_2023Valid()) as fc.Arbitrary<
